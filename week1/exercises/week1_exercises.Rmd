---
title: "regression_mle.Rmd"
output: html_document
---

1. ADD ME

2. [1] Carry out the “Prostate Cancer” example from Section 3.2.1 of Hastie et al. Having seen the correlations in Table 3.1 do you anticipate the opposite signs for lcp and lcavol on Table 3.2? Comment briefly
...
# Fit a linear model
# lm.beta standardizes the regressors
# install.packages('QuantPsyc')
library(QuantPsyc)
lm1 <- lm(lpsa ~ lcavol + lweight + age + lbph + svi + lcp + gleason + pgg45)
lm.beta(lm1)
```
...
```{r}
# Plot quantiles of the standardised residuals vs quantiles of a sample of 300 iid standard Gaussians, with the 45o line superimposed.
qqplot(synthetic_data.lm.stdres, synthetic_data$t)
