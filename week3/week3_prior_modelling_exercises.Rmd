...
Exploring the sensitvity of delta exposed that a large delta drives the values of the parameters to 0 and thus there is no correlation between x and the fitted values for t. A low delta or zero delta drives a closer fit to the observations.
