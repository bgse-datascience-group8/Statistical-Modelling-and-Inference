...
$q = 1/q$ (e.g. the precision; the question specifies the variance as $1/q$, but for simplicity above we use $q$ to be the variance, so the precision of the canonical is the precision of the Normal)
