...
(slide 9) Transformation of maximized log likelihood is cross-entropy transformed with some bias, bigger the model bigger the bias, the more data the less bias. Conclusion, as I increase M, on average the 

J - the curvature of the log likelihood
R - the gradiant of the log likelihood
J^(-1)R - the hat matrix
